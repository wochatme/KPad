...
namespace gfx
{
    ...
    PlatformFontWin::PlatformFontWin(const string16& font_name, int font_size)
    {
    ...
    // static
    PlatformFont* PlatformFont::CreateFromNativeFont(HFONT native_font)
    {
