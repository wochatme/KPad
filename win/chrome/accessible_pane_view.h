#ifndef __accessible_pane_view_h__
#define __accessible_pane_view_h__
...
public:
    ...
    virtual bool SetPaneFocus(int view_storage_id, view::View* initial_focus);
    ...
    // Overridden from view::FocusChangeListener:
    virtual void FocusWillChange(view::View* focused_before,
        view::View* focused_now);

    // Overridden from view::FocusTraversable:
    virtual view::FocusSearch* GetFocusSearch();
    virtual FocusTraversable* GetFocusTraversableParent();
    virtual view::View* GetFocusTraversableParentView();
...
#endif //__accessible_pane_view_h__
