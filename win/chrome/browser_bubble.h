#ifndef __browser_bubble_h__
#define __browser_bubble_h__
...
public:
    ...
    // The contained view.
    view::View* view() const { return view_; }
    ...
    HWND native_view() const { return popup_->GetNativeView(); }
