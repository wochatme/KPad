#ifndef __dragged_tab_controller_h__
#define __dragged_tab_controller_h__
...
private:
    ...
    typedef std::set<HWND> DockWindows;
    ...
    gfx::Rect GetViewScreenBounds(view::View* tabstrip) const;
...
#endif //__dragged_tab_controller_h__
