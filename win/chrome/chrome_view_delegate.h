#ifndef __chrome_view_delegate_h__
#define __chrome_view_delegate_h__

#include "base/memory/scoped_ptr.h"
#include "uiview/view_delegate.h"

class ChromeViewDelegate : public view::ViewDelegate
{
public:
    ChromeViewDelegate();
    virtual ~ChromeViewDelegate();
...
private:
    ...
    DISALLOW_COPY_AND_ASSIGN(ChromeViewDelegate);
};

#endif //__chrome_view_delegate_h__
