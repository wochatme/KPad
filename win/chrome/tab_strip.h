#ifndef __tab_strip_h__
#define __tab_strip_h__
...
#include "uibase/animation/animation_container.h"

#include "uiview/controls/button/image_button.h"
//#include "view/mouse_watcher.h"
...
class TabStrip : public BaseTabStrip,
    ...
    public view::MouseWatcherListener*/
{
public:
    ...
    virtual view::View* GetNewTabButton() OVERRIDE;
    ...
    //virtual void OnDragEntered(const view::DropTargetEvent& event) OVERRIDE;
    //virtual int OnDragUpdated(const view::DropTargetEvent& event) OVERRIDE;
    //virtual void OnDragExited() OVERRIDE;
    //virtual int OnPerformDrop(const view::DropTargetEvent& event) OVERRIDE;
    virtual void GetAccessibleState(ui::AccessibleViewState* state) OVERRIDE;
    virtual view::View* GetEventHandlerForPoint(const gfx::Point& point)
        OVERRIDE;
...
protected:
    ...
    // view::ButtonListener implementation:
...
private:
    ...
    struct DropInfo
    {
        ...
        view::Widget* arrow_window;
        view::ImageView* arrow_view;
    ...
    void UpdateDropIndex(const view::DropTargetEvent& event);
    ...
    int GetDropEffect(const view::DropTargetEvent& event);
    ...
    // The "New Tab" button.
    view::ImageButton* newtab_button_;
    ...
    //scoped_ptr<view::MouseWatcher> mouse_watcher_;

    DISALLOW_COPY_AND_ASSIGN(TabStrip);
};

#endif //__tab_strip_h__
