#ifndef __browser_non_client_frame_view_h__
#define __browser_non_client_frame_view_h__

#include "uiview/window/non_client_view.h"
...
#endif //__browser_non_client_frame_view_h__
