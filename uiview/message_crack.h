...
#define VIEW_MSG_WM_CREATE(func) \
	if (uMsg == WM_CREATE) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_INITDIALOG(func) \
...
#define VIEW_MSG_WM_COPYDATA(func) \
	if (uMsg == WM_COPYDATA) \
	{ \
		SetMsgHandled(TRUE); \
...
// void OnDestroy()
#define VIEW_MSG_WM_DESTROY(func) \
	if (uMsg == WM_DESTROY) \
	{ \
		SetMsgHandled(TRUE); \
		func(); \
...
// void OnMove(gfx::Point ptPos)
#define VIEW_MSG_WM_MOVE(func) \
	if (uMsg == WM_MOVE) \
	{ \
		SetMsgHandled(TRUE); \
        func(gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		lResult = 0; \
		if(IsMsgHandled()) \
			return TRUE; \
	}
...
#define VIEW_MSG_WM_SIZE(func) \
	...
	{ \
		SetMsgHandled(TRUE); \
		func((UINT)wParam, gfx::Size(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		lResult = 0; \
		if(IsMsgHandled()) \
			return TRUE; \
	}
...
#define VIEW_MSG_WM_ACTIVATE(func) \
	if (uMsg == WM_ACTIVATE) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_SETFOCUS(func) \
	if (uMsg == WM_SETFOCUS) \
	{ \
		SetMsgHandled(TRUE); \
		func((HWND)wParam); \
...
#define VIEW_MSG_WM_KILLFOCUS(func) \
...
#define VIEW_MSG_WM_ENABLE(func) \
	if (uMsg == WM_ENABLE) \
	{ \
		SetMsgHandled(TRUE); \
		func((BOOL)wParam); \
...
#define VIEW_MSG_WM_QUERYENDSESSION(func) \
...
// BOOL OnQueryOpen()
#define VIEW_MSG_WM_QUERYOPEN(func) \
...
#define VIEW_MSG_WM_ERASEBKGND(func) \
...
#define VIEW_MSG_WM_SYSCOLORCHANGE(func) \
...
#define VIEW_MSG_WM_ENDSESSION(func) \
...
#define VIEW_MSG_WM_SHOWWINDOW(func) \
...
#define VIEW_MSG_WM_CTLCOLOREDIT(func) \
...
#define VIEW_MSG_WM_CTLCOLORLISTBOX(func) \
...
#define VIEW_MSG_WM_CTLCOLORBTN(func) \
...
#define VIEW_MSG_WM_CTLCOLORDLG(func) \
...
#define VIEW_MSG_WM_CTLCOLORSCROLLBAR(func) \
...
#define VIEW_MSG_WM_CTLCOLORSTATIC(func) \
...
#define VIEW_MSG_WM_SETTINGCHANGE(func) \
...
#define VIEW_MSG_WM_DEVMODECHANGE(func) \
...
#define VIEW_MSG_WM_ACTIVATEAPP(func) \
...
// void OnFontChange()
#define VIEW_MSG_WM_FONTCHANGE(func) \
...
// void OnTimeChange()
#define VIEW_MSG_WM_TIMECHANGE(func) \
...
// void OnCancelMode()
#define VIEW_MSG_WM_CANCELMODE(func) \
...
#define VIEW_MSG_WM_SETCURSOR(func) \
...
#define VIEW_MSG_WM_MOUSEACTIVATE(func) \
...
#define VIEW_MSG_WM_CHILDACTIVATE(func) \
...
#define VIEW_MSG_WM_GETMINMAXINFO(func) \
...
#define VIEW_MSG_WM_ICONERASEBKGND(func) \
...
#define VIEW_MSG_WM_SPOOLERSTATUS(func) \
...
#define VIEW_MSG_WM_DRAWITEM(func) \
	if (uMsg == WM_DRAWITEM) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_MEASUREITEM(func) \
...
#define VIEW_MSG_WM_DELETEITEM(func) \
...
#define VIEW_MSG_WM_CHARTOITEM(func) \
...
#define VIEW_MSG_WM_VKEYTOITEM(func) \
...
#define VIEW_MSG_WM_QUERYDRAGICON(func) \
...
#define VIEW_MSG_WM_COMPAREITEM(func) \
...
#define VIEW_MSG_WM_COMPACTING(func) \
...
#define VIEW_MSG_WM_NCCREATE(func) \
	if (uMsg == WM_NCCREATE) \
	{ \
		SetMsgHandled(TRUE); \
		lResult = (LRESULT)func((LPCREATESTRUCT)lParam); \
...
// void OnNcDestroy()
#define VIEW_MSG_WM_NCDESTROY(func) \
...
#define VIEW_MSG_WM_NCCALCSIZE(func) \
...
#define VIEW_MSG_WM_NCHITTEST(func) \
	if (uMsg == WM_NCHITTEST) \
	{ \
		SetMsgHandled(TRUE); \
		lResult = (LRESULT)func(gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		if(IsMsgHandled()) \
			return TRUE; \
	}

// void OnNcPaint(CRgn rgn)
#define VIEW_MSG_WM_NCPAINT(func) \
	if (uMsg == WM_NCPAINT) \
	{ \
		SetMsgHandled(TRUE); \
		func((HRGN)wParam); \
...
#define VIEW_MSG_WM_NCACTIVATE(func) \
...
#define VIEW_MSG_WM_GETDLGCODE(func) \
...
#define VIEW_MSG_WM_NCMOUSEMOVE(func) \
	if (uMsg == WM_NCMOUSEMOVE) \
	{ \
		SetMsgHandled(TRUE); \
		func((UINT)wParam, gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		lResult = 0; \
		if(IsMsgHandled()) \
			return TRUE; \
	}
...
#define VIEW_MSG_WM_NCLBUTTONDOWN(func) \
...
#define VIEW_MSG_WM_NCLBUTTONUP(func) \
...
#define VIEW_MSG_WM_NCLBUTTONDBLCLK(func) \
...
#define VIEW_MSG_WM_NCRBUTTONDOWN(func) \
...
#define VIEW_MSG_WM_NCRBUTTONUP(func) \
...
// void OnNcRButtonDblClk(UINT nHitTest, gfx::Point point)
#define VIEW_MSG_WM_NCRBUTTONDBLCLK(func) \
...
// void OnNcMButtonDown(UINT nHitTest, gfx::Point point)
#define VIEW_MSG_WM_NCMBUTTONDOWN(func) \
...
// void OnNcMButtonUp(UINT nHitTest, gfx::Point point)
#define VIEW_MSG_WM_NCMBUTTONUP(func) \
...
// void OnNcMButtonDblClk(UINT nHitTest, gfx::Point point)
#define VIEW_MSG_WM_NCMBUTTONDBLCLK(func) \
...
#define VIEW_MSG_WM_KEYDOWN(func) \
	if (uMsg == WM_KEYDOWN) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_DEADCHAR(func) \
	if (uMsg == WM_DEADCHAR) \
	{ \
		SetMsgHandled(TRUE); \
		func((TCHAR)wParam, (UINT)lParam & 0xFFFF, (UINT)((lParam & 0xFFFF0000) >> 16)); \
...
#define VIEW_MSG_WM_SYSKEYDOWN(func) \
...
#define VIEW_MSG_WM_SYSKEYUP(func) \
	if (uMsg == WM_SYSKEYUP) \
	{ \
		SetMsgHandled(TRUE); \
		func((TCHAR)wParam, (UINT)lParam & 0xFFFF, (UINT)((lParam & 0xFFFF0000) >> 16)); \
...
#define VIEW_MSG_WM_SYSCHAR(func) \
	if (uMsg == WM_SYSCHAR) \
	{ \
		SetMsgHandled(TRUE); \
		func((TCHAR)wParam, (UINT)lParam & 0xFFFF, (UINT)((lParam & 0xFFFF0000) >> 16)); \
...
#define VIEW_MSG_WM_SYSDEADCHAR(func) \
...
#define VIEW_MSG_WM_SYSCOMMAND(func) \
...
#define VIEW_MSG_WM_HSCROLL(func) \
	if (uMsg == WM_HSCROLL) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_VSCROLL(func) \
	if (uMsg == WM_VSCROLL) \
	{ \
		SetMsgHandled(TRUE); \
		func((int)LOWORD(wParam), (short)HIWORD(wParam), (HWND)lParam); \
...
#define VIEW_MSG_WM_INITMENU(func) \
	if (uMsg == WM_INITMENU) \
	{ \
		SetMsgHandled(TRUE); \
		func((HMENU)wParam); \
...
#define VIEW_MSG_WM_INITMENUPOPUP(func) \
...
#define VIEW_MSG_WM_MENUSELECT(func) \
...
#define VIEW_MSG_WM_MENUCHAR(func) \
	if (uMsg == WM_MENUCHAR) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_NOTIFY(func) \
	if (uMsg == WM_NOTIFY) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_ENTERIDLE(func) \
...
// void OnMouseMove(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_MOUSEMOVE(func) \
...
// BOOL OnMouseWheel(UINT nFlags, short zDelta, gfx::Point pt)
#define VIEW_MSG_WM_MOUSEWHEEL(func) \
	if (uMsg == WM_MOUSEWHEEL) \
	{ \
		SetMsgHandled(TRUE); \
		lResult = (LRESULT)func((UINT)LOWORD(wParam), (short)HIWORD(wParam), gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		if(IsMsgHandled()) \
			return TRUE; \
	}

// void OnLButtonDown(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_LBUTTONDOWN(func) \
...
// void OnLButtonUp(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_LBUTTONUP(func) \
...
// void OnLButtonDblClk(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_LBUTTONDBLCLK(func) \
...
// void OnRButtonDown(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_RBUTTONDOWN(func) \
...
// void OnRButtonUp(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_RBUTTONUP(func) \
...
// void OnRButtonDblClk(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_RBUTTONDBLCLK(func) \
...
// void OnMButtonDown(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_MBUTTONDOWN(func) \
...
// void OnMButtonUp(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_MBUTTONUP(func) \
...
// void OnMButtonDblClk(UINT nFlags, gfx::Point point)
#define VIEW_MSG_WM_MBUTTONDBLCLK(func) \
...
#define VIEW_MSG_WM_PARENTNOTIFY(func) \
...
#define VIEW_MSG_WM_MDIACTIVATE(func) \
...
#define VIEW_MSG_WM_RENDERFORMAT(func) \
...
#define VIEW_MSG_WM_RENDERALLFORMATS(func) \
...
#define VIEW_MSG_WM_DESTROYCLIPBOARD(func) \
...
#define VIEW_MSG_WM_DRAWCLIPBOARD(func) \
...
#define VIEW_MSG_WM_PAINTCLIPBOARD(func) \
...
#define VIEW_MSG_WM_VSCROLLCLIPBOARD(func) \
...
// void OnContextMenu(CWindow wnd, gfx::Point point)
#define VIEW_MSG_WM_CONTEXTMENU(func) \
	if (uMsg == WM_CONTEXTMENU) \
	{ \
		SetMsgHandled(TRUE); \
		func((HWND)wParam, gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		lResult = 0; \
		if(IsMsgHandled()) \
			return TRUE; \
	}
...
#define VIEW_MSG_WM_SIZECLIPBOARD(func) \
...
#define VIEW_MSG_WM_ASKCBFORMATNAME(func) \
...
#define VIEW_MSG_WM_CHANGECBCHAIN(func) \
...
#define VIEW_MSG_WM_HSCROLLCLIPBOARD(func) \
...
#define VIEW_MSG_WM_QUERYNEWPALETTE(func) \
...
#define VIEW_MSG_WM_PALETTECHANGED(func) \
...
#define VIEW_MSG_WM_PALETTEISCHANGING(func) \
...
#define VIEW_MSG_WM_DROPFILES(func) \
...
#define VIEW_MSG_WM_WINDOWPOSCHANGING(func) \
...
#define VIEW_MSG_WM_WINDOWPOSCHANGED(func) \
...
#define VIEW_MSG_WM_EXITMENULOOP(func) \
...
#define VIEW_MSG_WM_ENTERMENULOOP(func) \
...
#define VIEW_MSG_WM_STYLECHANGED(func) \
...
#define VIEW_MSG_WM_STYLECHANGING(func) \
...
#define VIEW_MSG_WM_SIZING(func) \
	if (uMsg == WM_SIZING) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_MOVING(func) \
	if (uMsg == WM_MOVING) \
	{ \
		SetMsgHandled(TRUE); \
		func((UINT)wParam, (LPRECT)lParam); \
...
#define VIEW_MSG_WM_CAPTURECHANGED(func) \
...
#define VIEW_MSG_WM_DEVICECHANGE(func) \
...
#define VIEW_MSG_WM_COMMAND(func) \
	if (uMsg == WM_COMMAND) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_ENTERSIZEMOVE(func) \
...
// void OnExitSizeMove()
#define VIEW_MSG_WM_EXITSIZEMOVE(func) \
...
// HFONT OnGetFont()
#define VIEW_MSG_WM_GETFONT(func) \
	if (uMsg == WM_GETFONT) \
	{ \
		SetMsgHandled(TRUE); \
		lResult = (LRESULT)func(); \
...
// LRESULT OnGetHotKey()
#define VIEW_MSG_WM_GETHOTKEY(func) \
...
// HICON OnGetIcon()
#define VIEW_MSG_WM_GETICON(func) \
	if (uMsg == WM_GETICON) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_GETTEXT(func) \
	if (uMsg == WM_GETTEXT) \
	{ \
		SetMsgHandled(TRUE); \
...
// int OnGetTextLength()
#define VIEW_MSG_WM_GETTEXTLENGTH(func) \
...
#define VIEW_MSG_WM_HOTKEY(func) \
	if (uMsg == WM_HOTKEY) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_INPUTLANGCHANGE(func) \
...
#define VIEW_MSG_WM_INPUTLANGCHANGEREQUEST(func) \
...
#define VIEW_MSG_WM_NEXTDLGCTL(func) \
...
#define VIEW_MSG_WM_NEXTMENU(func) \
	if (uMsg == WM_NEXTMENU) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_NOTIFYFORMAT(func) \
...
#define VIEW_MSG_WM_POWERBROADCAST(func) \
...
#define VIEW_MSG_WM_PRINTCLIENT(func) \
...
#define VIEW_MSG_WM_RASDIALEVENT(func) \
...
#define VIEW_MSG_WM_SETFONT(func) \
	if (uMsg == WM_SETFONT) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_SETHOTKEY(func) \
...
#define VIEW_MSG_WM_SETICON(func) \
	if (uMsg == WM_SETICON) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_SETREDRAW(func) \
...
#define VIEW_MSG_WM_SETTEXT(func) \
	if (uMsg == WM_SETTEXT) \
	{ \
		SetMsgHandled(TRUE); \
...
// void OnUserChanged()
#define VIEW_MSG_WM_USERCHANGED(func) \
...
// void OnMouseHover(WPARAM wParam, gfx::Point ptPos)
#define VIEW_MSG_WM_MOUSEHOVER(func) \
	if (uMsg == WM_MOUSEHOVER) \
	{ \
		SetMsgHandled(TRUE); \
		func(wParam, gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		lResult = 0; \
		if(IsMsgHandled()) \
			return TRUE; \
	}
...
// void OnMouseLeave()
#define VIEW_MSG_WM_MOUSELEAVE(func) \
...
#define VIEW_MSG_WM_MENURBUTTONUP(func) \
...
#define VIEW_MSG_WM_MENUDRAG(func) \
	if (uMsg == WM_MENUDRAG) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MSG_WM_MENUGETOBJECT(func) \
...
#define VIEW_MSG_WM_UNINITMENUPOPUP(func) \
...
#define VIEW_MSG_WM_MENUCOMMAND(func) \
...
#define VIEW_MSG_WM_APPCOMMAND(func) \
...
// void OnNCXButtonDown(int fwButton, short nHittest, gfx::Point ptPos)
#define VIEW_MSG_WM_NCXBUTTONDOWN(func) \
	if (uMsg == WM_NCXBUTTONDOWN) \
	{ \
		SetMsgHandled(TRUE); \
		func(GET_XBUTTON_WPARAM(wParam), GET_NCHITTEST_WPARAM(wParam), gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		lResult = 0; \
		if(IsMsgHandled()) \
			return TRUE; \
	}

// void OnNCXButtonUp(int fwButton, short nHittest, gfx::Point ptPos)
#define VIEW_MSG_WM_NCXBUTTONUP(func) \
...
// void OnNCXButtonDblClk(int fwButton, short nHittest, gfx::Point ptPos)
#define VIEW_MSG_WM_NCXBUTTONDBLCLK(func) \
...
// void OnXButtonDown(int fwButton, int dwKeys, gfx::Point ptPos)
#define VIEW_MSG_WM_XBUTTONDOWN(func) \
	if (uMsg == WM_XBUTTONDOWN) \
	{ \
		SetMsgHandled(TRUE); \
		func(GET_XBUTTON_WPARAM(wParam), GET_KEYSTATE_WPARAM(wParam), gfx::Point(GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam))); \
		lResult = 0; \
		if(IsMsgHandled()) \
			return TRUE; \
	}

// void OnXButtonUp(int fwButton, int dwKeys, gfx::Point ptPos)
#define VIEW_MSG_WM_XBUTTONUP(func) \
...
// void OnXButtonDblClk(int fwButton, int dwKeys, gfx::Point ptPos)
#define VIEW_MSG_WM_XBUTTONDBLCLK(func) \
...
#define VIEW_MSG_WM_CHANGEUISTATE(func) \
...
#define VIEW_MSG_WM_UPDATEUISTATE(func) \
...
#define VIEW_MSG_WM_QUERYUISTATE(func) \
...
#define VIEW_MSG_WM_UNICHAR(func) \
	if (uMsg == WM_UNICHAR) \
	{ \
		SetMsgHandled(TRUE); \
		func((TCHAR)wParam, (UINT)lParam & 0xFFFF, (UINT)((lParam & 0xFFFF0000) >> 16)); \
...
#define VIEW_MSG_WM_WTSSESSION_CHANGE(func) \
...
// OnThemeChanged()
#define VIEW_MSG_WM_THEMECHANGED(func) \
...
#define VIEW_MSG_WM_FORWARDMSG(func) \
...
#define VIEW_MSG_DM_GETDEFID(func) \
	if (uMsg == DM_GETDEFID) \
	{ \
		SetMsgHandled(TRUE); \
		lResult = func(); \
...
#define VIEW_MSG_DM_SETDEFID(func) \
	if (uMsg == DM_SETDEFID) \
	{ \
		SetMsgHandled(TRUE); \
		func((UINT)wParam); \
...
// void OnDMReposition()
#define VIEW_MSG_DM_REPOSITION(func) \
...
#define VIEW_MSG_OCM_COMMAND(func) \
	if (uMsg == OCM_COMMAND) \
	{ \
		SetMsgHandled(TRUE); \
		func((UINT)HIWORD(wParam), (int)LOWORD(wParam), (HWND)lParam); \
...
#define VIEW_MSG_OCM_NOTIFY(func) \
	if (uMsg == OCM_NOTIFY) \
	{ \
		SetMsgHandled(TRUE); \
		lResult = func((int)wParam, (LPNMHDR)lParam); \
...
#define VIEW_MSG_OCM_PARENTNOTIFY(func) \
...
#define VIEW_MSG_OCM_DRAWITEM(func) \
...
#define VIEW_MSG_OCM_MEASUREITEM(func) \
...
#define VIEW_MSG_OCM_COMPAREITEM(func) \
...
#define VIEW_MSG_OCM_DELETEITEM(func) \
...
#define VIEW_MSG_OCM_VKEYTOITEM(func) \
...
#define VIEW_MSG_OCM_CHARTOITEM(func) \
...
#define VIEW_MSG_OCM_HSCROLL(func) \
	if (uMsg == OCM_HSCROLL) \
	{ \
		SetMsgHandled(TRUE); \
		func((int)LOWORD(wParam), (short)HIWORD(wParam), (HWND)lParam); \
...
#define VIEW_MSG_OCM_VSCROLL(func) \
	if (uMsg == OCM_VSCROLL) \
	{ \
		SetMsgHandled(TRUE); \
		func((int)LOWORD(wParam), (short)HIWORD(wParam), (HWND)lParam); \
...
#define VIEW_MSG_OCM_CTLCOLOREDIT(func) \
...
#define VIEW_MSG_OCM_CTLCOLORLISTBOX(func) \
...
#define VIEW_MSG_OCM_CTLCOLORBTN(func) \
...
#define VIEW_MSG_OCM_CTLCOLORDLG(func) \
...
#define VIEW_MSG_OCM_CTLCOLORSCROLLBAR(func) \
...
#define VIEW_MSG_OCM_CTLCOLORSTATIC(func) \
...
#define VIEW_MESSAGE_HANDLER_EX(msg, func) \
	if(uMsg == msg) \
	{ \
		SetMsgHandled(TRUE); \
...
#define VIEW_MESSAGE_RANGE_HANDLER_EX(msgFirst, msgLast, func) \
...
#define VIEW_COMMAND_HANDLER_EX(id, code, func) \
...
#define VIEW_COMMAND_ID_HANDLER_EX(id, func) \
...
#define VIEW_COMMAND_CODE_HANDLER_EX(code, func) \
...
#define VIEW_NOTIFY_HANDLER_EX(id, cd, func) \
...
#define VIEW_NOTIFY_ID_HANDLER_EX(id, func) \
...
#define VIEW_NOTIFY_CODE_HANDLER_EX(cd, func) \
...
#define VIEW_COMMAND_RANGE_HANDLER_EX(idFirst, idLast, func) \
...
#define VIEW_COMMAND_RANGE_CODE_HANDLER_EX(idFirst, idLast, code, func) \
...
#define VIEW_NOTIFY_RANGE_HANDLER_EX(idFirst, idLast, func) \
...
#define VIEW_NOTIFY_RANGE_CODE_HANDLER_EX(idFirst, idLast, cd, func) \
...
#define VIEW_REFLECTED_COMMAND_HANDLER_EX(id, code, func) \
...
#define VIEW_REFLECTED_COMMAND_ID_HANDLER_EX(id, func) \
...
#define VIEW_REFLECTED_COMMAND_CODE_HANDLER_EX(code, func) \
...
#define VIEW_REFLECTED_NOTIFY_HANDLER_EX(id, cd, func) \
...
#define VIEW_REFLECTED_NOTIFY_ID_HANDLER_EX(id, func) \
...
#define VIEW_REFLECTED_NOTIFY_CODE_HANDLER_EX(cd, func) \
...
#define VIEW_REFLECTED_COMMAND_RANGE_HANDLER_EX(idFirst, idLast, func) \
...
#define VIEW_REFLECTED_COMMAND_RANGE_CODE_HANDLER_EX(idFirst, idLast, code, func) \
...
#define VIEW_REFLECTED_NOTIFY_RANGE_HANDLER_EX(idFirst, idLast, func) \
...
#define VIEW_REFLECTED_NOTIFY_RANGE_CODE_HANDLER_EX(idFirst, idLast, cd, func) \
