#ifndef __view_native_widget_private_h__
#define __view_native_widget_private_h__
...
namespace view
{
    ...
    namespace internal
    {
        ...
        public:
            ...
            static void GetAllChildWidgets(HWND native_view,
                Widget::Widgets* children);
            static void ReparentNativeView(HWND native_view,
                HWND new_parent);
...
#endif //__view_native_widget_private_h__
