#ifndef __view_tooltip_manager_win_h__
#define __view_tooltip_manager_win_h__
...
namespace view
{
    ...
    //   VIEW_MESSAGE_RANGE_HANDLER(WM_NCMOUSEMOVE, WM_NCXBUTTONDBLCLK, OnMouseRange)
...
#endif //__view_tooltip_manager_win_h__
