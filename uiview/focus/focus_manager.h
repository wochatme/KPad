#ifndef __view_focus_manager_h__
#define __view_focus_manager_h__
...
#include "uiview/accelerator.h"
#include "uiview/event/event.h"
...
namespace view
{
    ...
    private:
        ...
        View* FindFocusableView(FocusTraversable* focus_traversable,
            View* starting_view, bool reverse);
...
#endif //__view_focus_manager_h__
