...
#include "uibase/gfx/native_widget_types.h"
#include "uibase/shell_dialogs/base_shell_dialog_win.h"
#include "uibase/shell_dialogs/shell_dialogs_delegate.h"

#if defined(USE_AURA)
#include "ui_base/aura/remote_root_window_host_win.h"
#include "ui_base/aura/root_window.h"
#endif
...
namespace {
    ...
    private:
        ...
        void MultiFilesSelected(const std::vector<FilePath>& paths,
            void* params,
            RunState run_state);
