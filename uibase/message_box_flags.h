#ifndef __ui_base_message_box_flags_h__
#define __ui_base_message_box_flags_h__
...
namespace ui
{
    ...
    public:
        ...
        static const int kIsConfirmMessageBox = kFlagHasMessage |
            kFlagHasOKButton | kFlagHasCancelButton;
...
#endif //__ui_base_message_box_flags_h__
